...
from trajectory_baseline.model import LSTMTrajectoryPredictor
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Phase 1 nuScenes LSTM baseline")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_metrics["ade"] < best_val_ade:
            ...
            checkpoint_path = save_dir / "phase1_lstm_best.pt"
            torch.save(
                {
