...
from trajectory_baseline.model import TransformerMapTrajectoryPredictor
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Phase 2 Transformer + map baseline")
    ...
    model = TransformerMapTrajectoryPredictor(
        input_dim=6,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_metrics["ade"] < best_val_ade:
            ...
            checkpoint_path = save_dir / "phase2_transformer_map_best.pt"
            torch.save(
                {
